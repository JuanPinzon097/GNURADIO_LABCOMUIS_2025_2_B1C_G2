...
class Mision2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._Am_range = qtgui.Range(0, 1, 0.01, 0.1, 200)
        self._Am_win = qtgui.RangeWidget(self._Am_range, self.set_Am, "Amplitud Señal", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.analog_const_source_x_0 = analog.sig_source_c(0, analog.GR_CONST_WAVE, 0, 0, Am)

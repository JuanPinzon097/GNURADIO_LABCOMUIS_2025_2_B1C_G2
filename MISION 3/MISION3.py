...
# Title: MISION3 - E1C G5
# Author: ALVAREZ_URIBE
# Copyright: UIS
...
class MISION3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "MISION3 - E1C G5", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("MISION3 - E1C G5")
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/estudiante/Descargas/Corazón partío.wav', True)
